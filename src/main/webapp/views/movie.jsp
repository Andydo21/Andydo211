...
<body>
    ...
    <div class="container-fluid px-5">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav main-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="${pageContext.request.contextPath}/movie">Phim</a>
          </li>
          <li class="nav-item">
  ...
  <section class="movie-filter">
    <div class="filter-row">
      <form:form method="get" modelAttribute="filter" action="${pageContext.request.contextPath}/movies">
