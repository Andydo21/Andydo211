...
public class User implements UserDetails {
    ...
    public List<UserMovieList> getUserMovieLists() { return userMovieLists; }
    public void setUserMovieLists(List<UserMovieList> userMovieLists) { this.userMovieLists = userMovieLists; }
