...
public class Episode {
    ...
    public @NotNull(message = "URL video không được để trống") String getVideoPublicId() {
        return videoPublicId;
    }

    public void setVideoPublicId(@NotNull(message = "URL video không được để trống") String videoPublicId) {
    ...
    private String episode; // Số tập (ví dụ: "1", "2")
